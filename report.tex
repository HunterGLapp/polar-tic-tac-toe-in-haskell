...
is about.  50-100 words is generally a good guideline for length. Generally speaking,
you should provide a summary (very brief) of the main results.
\end{abstract}
...
are implemented, as a preface to the next subsection. This is also where you introduce
the specific problem to be solved (e.g., Polar Tic-Tac-Toe, Konane, the Racetrack Problem).
...
\subsection{Reinforcement Learning and Games}
